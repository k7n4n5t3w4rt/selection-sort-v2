...
export function gridDisplay (
  ...
  function swapCells (
    ...
    if (!_1Cell.id || !_2Cell.id) {
      console.error('There was a problem getting the DOM elements we want to swap...')
    }
    ...
    return Promise.all(
      [
        this.moveCell(_1Cell, _2CellData.x, _2CellData.y, transitionSpeed)
          .then(_1Cell => {
            this.moveCellBackQuickly(_1Cell, _1CellData.x, _1CellData.y)
            this.setNewCellColour(_1Cell, _2CellData.value)
          }),
        this.moveCell(_2Cell, _1CellData.x, _1CellData.y, transitionSpeed)
          .then(_2Cell => {
